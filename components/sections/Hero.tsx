...
export function Hero({ highlights }: HeroProps) {
  ...
  // Parallax for the 2D talisman is intentionally disabled, so the vertical offset stays at zero.
  const orbShift = useTransform(scrollYProgress, [0, 0], [0, 0]);
          ...
          >
            ...
            <div className="relative z-20 h-full w-full overflow-visible">
              <Image
                ...
                height={780}
                priority
                // !!! ИСПРАВЛЕНИЕ: ДОБАВЛЕНИЕ pointer-events-none !!!
                className="absolute -top-20 -right-14 z-20 h-auto w-[380px] max-w-none object-contain drop-shadow-[0_65px_170px_rgba(12,74,110,0.5)] sm:w-[470px] lg:w-[560px] xl:w-[620px] **pointer-events-none**"
