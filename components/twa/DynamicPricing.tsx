    ...
    return (
      <div className="relative overflow-hidden border border-[#66FCF1]/30 bg-[#020304] p-8 md:p-12 shadow-[0_0_50px_rgba(102,252,241,0.1)]" style={{ clipPath: "polygon(0 20px, 20px 0, 100% 0, 100% calc(100% - 20px), calc(100% - 20px) 100%, 0 100%)" }}>
        ...
        <div className="flex gap-4">
          <Button className="bg-[#66FCF1] text-black hover:bg-[#45ece0] shadow-[0_0_20px_rgba(102,252,241,0.4)] font-bold uppercase tracking-wider rounded-none" style={{ clipPath: "polygon(0 0, 100% 0, 100% calc(100% - 10px), calc(100% - 10px) 100%, 0 100%)" }}>
